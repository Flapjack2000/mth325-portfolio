---
{"dg-publish":true,"permalink":"/concept-definitions/subgraphs-and-connectivity/"}
---
...
The graph shown below has two connected components.
...
<div style="display:flex; justify-content:center;">
	<figure style="width:50%; text-align:center">
	  ...
	  <figcaption><i>A graph with two connected components.</i></figcaption>
	</figure>
</div>
